...
$_LANG['cfg_name']['shop_address'] = '门店地址';
$_LANG['cfg_name']['shop_address_coord'] = '门店地址坐标（腾讯地图）';
$_LANG['cfg_name']['order_attention'] = '下单提醒';
...
$_LANG['cfg_name']['ecsdxt_sms_validtime'] = '短信验证码有效时间';
$_LANG['cfg_desc']['ecsdxt_sms_validtime'] = '短信验证码有效时间，过期失效（单位秒）';
